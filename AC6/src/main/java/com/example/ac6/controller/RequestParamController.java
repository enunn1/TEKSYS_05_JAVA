package com.example.ac6.controller;
...
public class RequestParamController {
	...
	public String handler(@RequestParam("name") String name, @RequestParam("age") int age,
		...
		return "URL parameters - <br>" + " name = " + name + " <br>" + " age = " + age + " <br>" + " amount = " + amount
				+ " <br>" + " active = " + active;
	}
	 ...
	 * method parameter as Optional i.e. it binds a null value to a method parameter
	...
	@ResponseBody
	public String handler(@RequestParam("country") String[] country, @RequestParam("city") List<String> city) {
