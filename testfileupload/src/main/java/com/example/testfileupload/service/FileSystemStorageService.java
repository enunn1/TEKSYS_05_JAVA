...
public class FileSystemStorageService implements StorageService {
	...
	public void store(MultipartFile file) {
		try {
			...
			if(!destinationFile.getParent().equals(this.rootLocation.toAbsolutePath())) {
				throw new StorageException("cannot store file in this location");
			}
			...
			throw new StorageException("Failed to store fiel in location", e);
		}
	}
	...
	public void init() {
		try {
			...
			throw new StorageException("Could not initiliaze storage", e);
		}
